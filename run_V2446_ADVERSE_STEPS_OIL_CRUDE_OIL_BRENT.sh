...
export V244_TRADED_ASSET=OIL_CRUDE
...
mkdir -p data/execution
export V244_CONFIRM_ASSET=OIL_BRENT
export V244_EXCLUDED_ASSETS=

export V244_STATE_FILE=data/execution/V2442_NETTING_STATE_OIL_CRUDE.json
export V244_LOCK_FILE=data/execution/V244_FORCED_RUNNER_LOCK_OIL_CRUDE
export V244_PROTECTED_DEAL_IDS=

export V244_AUDIT_DIR=logs/v24_4_forced_audit_OIL_CRUDE_OIL_BRENT
...
echo "RUN V2446 LIVE ISOLATED OIL_CRUDE/OIL_BRENT"
