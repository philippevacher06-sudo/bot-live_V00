...
# V2446K4_CLASSIC_OPEN_CALLPATH_FOR_ADVERSE_STEP
# En mode ADVERSE_PRICE_STEPS, on laisse open_market_netting_safe être appelé.
# Le wrapper adverse-step/V2446I décide ensuite si l'ouverture est autorisée.
export V244_DISABLE_CLASSIC_BASKET_OPEN=0

export V244_TRADED_ASSET=US500

# V2446K3_STATE_PER_ASSET
# Chaque actif a son propre état adverse-step.
