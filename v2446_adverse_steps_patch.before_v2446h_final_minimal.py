...
def _gate(r):
    ...
    configured_step = _envf("V244_PRICE_STEP_POINTS", 1.0)
    min_effective_step = _envf("V244_MIN_EFFECTIVE_STEP_POINTS", 2.0)
    spread_step_mult = _envf("V244_SPREAD_STEP_MULT", 1.5)
    ...
    ps = [p for p in all_ps if p.get("epic") == a]
