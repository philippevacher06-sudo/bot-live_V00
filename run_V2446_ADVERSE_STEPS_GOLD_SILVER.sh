...
mkdir -p data/execution
export V244_CONFIRM_ASSET=SILVER
export V244_EXCLUDED_ASSETS=

export V244_STATE_FILE=data/execution/V2442_NETTING_STATE_GOLD.json
export V244_LOCK_FILE=data/execution/V244_FORCED_RUNNER_LOCK_GOLD
export V244_PROTECTED_DEAL_IDS=00601567-0055-311e-0000-000084ad1031

export V244_AUDIT_DIR=logs/v24_4_forced_audit_GOLD_SILVER
...
echo "RUN V2446 LIVE ISOLATED GOLD/SILVER"
