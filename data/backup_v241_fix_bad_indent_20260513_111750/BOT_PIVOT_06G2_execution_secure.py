...
${indent}still_active = asset in exec_state.get("active", {})

${indent}if still_active:
${indent}    print(
${indent}        f"{asset:10s} | BASKET_KEEP | 1-3 | {active_exec.get('direction', '--'):4s} | "
${indent}        f"--         | TRADEABLE | cycle moteur IDLE ignoré, panier conservé"
${indent}    )
${indent}else:
${indent}    print(
${indent}        f"{asset:10s} | BASKET_PROCESSED_REMOVED | 1-3 | {active_exec.get('direction', '--'):4s} | "
${indent}        f"--         | TRADEABLE | panier traité puis supprimé/annulé"
${indent}    )
