#!/usr/bin/env bash
# V24.1 — Chargement robuste des variables Capital.com
cd "$(dirname "$0")"
...
PRINT_EVERY=30
PAUSE_SECONDS=30
MIN_SPREAD_SAMPLES=300

# Fraîcheur du contexte
REFRESH_MARKETS_SECONDS=3600     # 1 heure
REFRESH_ZONES_SECONDS=7200       # 2 heures
REFRESH_HISTORY_SECONDS=14400    # 4 heures
