    ...
    while True:
        try:
            ...
            if closed_count > 0:
                ...
                log(
                    "RUNNER_ETH_BASKET_NOT_READY_OPEN_FLOW_CONTINUES",
                    asset=ASSET,
                    close_info=close_info,
                )
                pass
