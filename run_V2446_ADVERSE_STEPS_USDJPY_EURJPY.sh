...
export V244_TRADED_ASSET=USDJPY
...
mkdir -p data/execution
export V244_CONFIRM_ASSET=EURJPY
export V244_EXCLUDED_ASSETS=

export V244_STATE_FILE=data/execution/V2442_NETTING_STATE_USDJPY.json
export V244_LOCK_FILE=data/execution/V244_FORCED_RUNNER_LOCK_USDJPY
export V244_PROTECTED_DEAL_IDS=

export V244_AUDIT_DIR=logs/v24_4_forced_audit_USDJPY_EURJPY
...
echo "RUN V2446 LIVE ISOLATED USDJPY/EURJPY"
