...
def v24_validate_bollinger_limit_levels(asset, direction, levels, price_audit=None, cycle_id=None):
    ...
    # V24.3.5F_DEMO_FORCE_ENTRY_SAMPLES:
    # En DEMO collecte, BB_TOO_FAR devient un warning pour generer plus d'exemples.
    demo_force_samples = str(__import__("os").getenv("V2435F_DEMO_FORCE_ENTRY_SAMPLES", "0")).lower() in (
        "1", "true", "yes", "y", "on"
    )
