...
def build_open_payload_secure(cycle):
    ...
    - stop garanti
    - stopDistance
    - profitDistance calculé depuis tp_eur réel converti selon la devise de cotation
    """
    payload = B.build_open_payload(cycle)
    payload["profitDistance"] = take_profit_distance(cycle)
    return payload
...
BOLLINGER_BASKET_CONFIG = {
    ...
    "US500": {"buffer": 0.8, "step": 3.0, "decimals": 1},
    "US100": {"buffer": 2.0, "step": 10.0, "decimals": 1},
    "US30": {"buffer": 4.0, "step": 15.0, "decimals": 1},
    "DE40": {"buffer": 2.0, "step": 8.0, "decimals": 1},
    "FRA40": {"buffer": 1.5, "step": 6.0, "decimals": 1},
    "FR40": {"buffer": 1.5, "step": 6.0, "decimals": 1},
    "UK100": {"buffer": 1.0, "step": 4.0, "decimals": 1},
    "J225": {"buffer": 10.0, "step": 50.0, "decimals": 1},

    "GOLD": {"buffer": 0.5, "step": 3.0, "decimals": 2},
    "SILVER": {"buffer": 0.02, "step": 0.1, "decimals": 3},
    "OIL_BRENT": {"buffer": 0.03, "step": 0.15, "decimals": 2},
    "OIL_CRUDE": {"buffer": 0.03, "step": 0.15, "decimals": 2},
    "NATURALGAS": {"buffer": 0.01, "step": 0.05, "decimals": 3},

    "EURUSD": {"buffer": 5e-05, "step": 0.0002, "decimals": 5},
    "GBPUSD": {"buffer": 5e-05, "step": 0.0002, "decimals": 5},
    "USDJPY": {"buffer": 0.005, "step": 0.03, "decimals": 3},
    "EURJPY": {"buffer": 0.008, "step": 0.04, "decimals": 3},

    "ETHUSD": {"buffer": 1.0, "step": 4.0, "decimals": 2},
    "BTCUSD": {"buffer": 25.0, "step": 100.0, "decimals": 2},
}
